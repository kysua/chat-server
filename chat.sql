...
CREATE TABLE `user` (
  -- MODIFICATION: Changed id from INT to BIGINT to match long long in C++
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `name` varchar(50) DEFAULT NULL,
  `password` varchar(50) DEFAULT NULL,
  -- MODIFICATION: Removed the 'state' column. This is now managed by Redis.
  PRIMARY KEY (`id`),
  UNIQUE KEY `name` (`name`)
) ENGINE=InnoDB AUTO_INCREMENT=22 DEFAULT CHARSET=utf8mb4; -- MODIFICATION: Changed charset to utf8mb4
...
-- MODIFICATION: Removed the 'state' values from the INSERT statement.
INSERT INTO `user` (`id`, `name`, `password`) VALUES (13,'zhang san','123456'),(15,'li si','666666'),(16,'liu shuo','123456'),(18,'wu yang','123456'),(19,'pi pi','123456'),(21,'gao yang','123456');
...
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `friend` (
  -- MODIFICATION: Changed userid and friendid to BIGINT
  `userid` bigint(20) NOT NULL,
  `friendid` bigint(20) NOT NULL,
  -- We can add a primary key to prevent duplicate friend entries
  PRIMARY KEY (`userid`,`friendid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4; -- MODIFICATION: Changed charset to utf8mb4
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4; -- MODIFICATION: Changed charset to utf8mb4
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `groupuser` (
  ...
  -- MODIFICATION: Changed userid to BIGINT
  `userid` bigint(20) NOT NULL,
...
INSERT INTO `groupuser` VALUES (1,13,'creator'),(1,19,'normal'),(1,21,'normal');
